...
assert_contains "$README" "Cursor から使う" "T4 README Cursor section"
assert_contains "$SKILL" "## Cursor" "T4 SKILL Cursor section"
assert_contains "$SKILL" "browser_state:" "T4 SKILL browser state guidance"
assert_file_exists "$ROOT/docs/oracle-adoptions.md" "T4 oracle adoptions doc"
assert_file_exists "$ROOT/.cursor/commands/gpt-pro-review.md" "T4 Cursor command"
assert_file_exists "$ROOT/AGENTS.md" "T4 AGENTS.md"
